...
def cal(S):
    ...
    v1.append(rs1[1][rs1[1]['总价']==rs1[1]['总价'].min()].iloc[[0]])
    v2.append(rs1[1][rs1[1]['总能力']==rs1[1]['总能力'].max()].iloc[[0]])
    v3.append(rs1[1][rs1[1]['得分']==rs1[1]['得分'].max()].iloc[[0]])
    ...
    v1.append(newd[newd['总价']==newd['总价'].min()].iloc[[0]])
    v2.append(newd[newd['总能力']==newd['总能力'].max()].iloc[[0]])
    v3.append(newd[newd['得分']==newd['得分'].max()].iloc[[0]])
    ...
    v1.append(rs2[3][rs2[3]['总价']==rs2[3]['总价'].min()].iloc[[0]])
    v2.append(rs2[3][rs2[3]['总能力']==rs2[3]['总能力'].max()].iloc[[0]])
    v3.append(rs2[3].iloc[[0]])
    ...
    v1.append(rs3[0][rs3[0]['总价']==rs3[0]['总价'].min()].iloc[[0]])
    v2.append(rs3[0][rs3[0]['总能力']==rs3[0]['总能力'].max()].iloc[[0]])
    v3.append(rs3[0][rs3[0]['得分']==rs3[0]['得分'].max()].iloc[[0]])
    ...
    v1.append(rs3[1][rs3[1]['总价']==rs3[1]['总价'].min()].iloc[[0]])
    v2.append(rs3[1][rs3[1]['总能力']==rs3[1]['总能力'].max()].iloc[[0]])
    v3.append(rs3[1][rs3[1]['得分']==rs3[1]['得分'].max()].iloc[[0]])
    ...
    v3.append(rs4[1][rs4[1]['得分']==rs4[1]['得分'].max()].iloc[[0]])
...
def calCheap(S):
    ...
    rs3=[]
    rs4=[]
    re, v1,v2,v3=cal(210,rs1,rs2,rs3,rs4)
    rr01=rs1[0][rs1[0]['总价']==rs1[0]['总价'].min()].iloc[[0]]
    print(type(rr01))
    rr1=pd.concat(rs1).to_json(orient="records", force_ascii = False)
    print(pd.concat(rs1))
    # print(max(rr1, key=lambda x: x[3]))
    return rs1
